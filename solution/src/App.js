    ...
    <div className="max-w-lg mx-auto shadow p-6 my-auto">
      <div className="flex flex-col mb-5">
        <div className="mb-2 flex flex-row gap-4 items-center justify-center">
          <label for="username" className="block text-sm font-medium min-w-16">
            Name
          </label>
          <input
            type="text"
      ...
      <div className="flex flex-col">
        <div className="mb-2 flex flex-row gap-4 items-center justify-center">
          <label for="location" className="block text-sm font-medium min-w-16">
            Location
          </label>
          <select
            id="location"
          ...
          >
            {locations &&
              ...
              locations.map((location, key) => {
                return <option value={key}>{location}</option>;
              })}
          </select>
        </div>
      </div>
      ...
      <div className="flex flex-row mt-20 gap-4 justify-end">
        <button
          className="px-3 py-2 text-base font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
            ...
            {data.map((item, index) => {
              return (
                <tr className={`${index % 2 === 0 ? "bg-gray-300" : "bg-gray-400"} border-b border-gray-400 text-black`}>
                  ...
                  <td className="px-6 py-4">{locations[item.location]}</td>
                </tr>
              );
            })}
          </tbody>
